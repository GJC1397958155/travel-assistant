...
import { Bot, Check, Edit2, Loader2, Plane, Send, Square, User } from 'lucide-react';
...
function QuickChips({ onQuickClick }: QuickChipsProps) {
  return (
...
function MessageBubble({ message, onQuestionClick }: MessageBubbleProps) {
